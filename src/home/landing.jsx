                            ...
                            <div class="col-md-7">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">
                                        ...
                                        service print submissions. Full service within The Spark generally costs $1.00
                                        per print hour and includes:
                                    </p>
                                    <ul>
                                    ...
                                    <p class="card-text">
                                        ...
                                        website for more information about the 3D printers we have in our collection.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col">
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            ...
                            <ul>
                                <li>
                                    Complete Contact information- All communication is via email, please confirm that
                                    the email you include is one you check regularly
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            Upload files separately; use the ‘add a file’ or ‘remove a file’ button as
                                            needed
                                        </li>
                                        <li>
                    ...
                    <div class="card shadow">
                        <div class="card-body">
                            <p>
                                The Spark is not allowed to make changes to submitted files, so please verify the print
                                files meet your desired expectations before submitting. 3D prints often require supports
                                in order to print,
                                <a
